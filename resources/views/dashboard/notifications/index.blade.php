                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-150px">@lang('dashboard.sent_at')</th>
                    ...
                    <tbody class="fw-bold text-gray-600">
                        @foreach ($notifications  as $notification)
                            ...
                            <tr data-id="{{$notification->id}}">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="#" class="symbol symbol-50px">
                                            <span class="symbol-label" style="background-image:url({{$notification->sender['image'] ?? null}});"></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            ...
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bolder">{{$notification->sender['name'] ?? null}}</div>
                                            <!--end::Description-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <!--begin::Badges-->
                                   <div class="text-muted fs-7 fw-bolder">{{$notification->created_at->diffForHumans()}}</div>
                                    <!--end::Badges-->
                                </td>
                                <!--end::Type=-->
                                <!--begin::Action=-->
