                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-ecommerce-order-filter="search"
                                class="form-control form-control-solid w-250px ps-14" placeholder="@lang('dashboard.search_title', ['page_title' => __('dashboard.user_order')])">
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--end::Card title-->
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <div class="input-group w-250px">
                            <input class="form-control form-control-solid rounded rounded-end-0 flatpickr-input"
                                placeholder="@lang('dashboard.pick_date_range')" id="kt_ecommerce_sales_flatpickr" type="hidden">
                        ...
                        <div class="w-100 mw-150px">
                            ...
                            data-hide-search="true" data-placeholder="@lang('dashboard.order_status')" data-kt-ecommerce-order-filter="status"
                            ...
                            <option value="1">@lang('apis.status_accepted')</option>
                            <option value="0">@lang('apis.status_pending')</option>
                            <option value="4">@lang('apis.status_refused')</option>
                            <option value="5">@lang('apis.status_canceled')</option>
                            <option value="2">@lang('apis.status_depositpaid')</option>
                            <option value="3">@lang('apis.status_paid')</option>
                        </select>
                            <!--end::Select2-->
                        </div>
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-100px sorting" tabindex="0"
                                            ...
                                            style="width: 111.062px;">@lang('dashboard.order_num')</th>
                                        <th class="min-w-100px sorting" tabindex="0"
                                            aria-controls="kt_ecommerce_sales_table" rowspan="1" colspan="1"
                                            aria-label="Customer: activate to sort column ascending"
                                            style="width:  111.062px;">@lang('dashboard.renter')</th>
                                        <th class="text-end min-w-70px sorting" tabindex="0"
                                            aria-controls="kt_ecommerce_sales_table" rowspan="1" colspan="1"
                                            aria-label="Status: activate to sort column ascending"
                                            style="width: 80.875px;">{{ __('dashboard.order_status')}}</th>
                                        <th class="text-end min-w-100px sorting" tabindex="0"
                                            aria-controls="kt_ecommerce_sales_table" rowspan="1" colspan="1"
                                            aria-label="Total: activate to sort column ascending"
                                            style="width: 111.062px;"> {{__('dashboard.cost')}}</th>
                                        <th class="text-end min-w-100px sorting" tabindex="0"
                                            aria-controls="kt_ecommerce_sales_table" rowspan="1" colspan="1"
                                            aria-label="Date Added: activate to sort column ascending"
                                            style="width: 111.062px;">@lang('dashboard.date_added')</th>
                                        <th class="text-end min-w-100px sorting" tabindex="0"
                                            aria-controls="kt_ecommerce_sales_table" rowspan="1" colspan="1"
                                            aria-label="Date Modified: activate to sort column ascending"
                                            style="width: 111.062px;">@lang('dashboard.date_modified')</th>
                                        <th class="text-end min-w-100px sorting_disabled" rowspan="1" colspan="1"
                                            aria-label="Actions" style="width: 111.109px;">@lang('dashboard.actions')</th>
                                    </tr>
                                    <!--end::Table row-->
                                </thead>
                                <!--end::Table head-->
                                        ...
                                        <tr class="{{ $loop->iteration % 2 == 0 ? 'even' : 'odd' }}">
                                            ...
                                            <td class="text-end">
                                                <a href="#" class="btn btn-sm btn-light btn-active-light-primary"
                                                    ...
                                                    data-kt-menu-placement="bottom-end">@lang('dashboard.actions')
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('orders.edit', $order->id) }}"
                                                            class="menu-link px-3">@lang('dashboard.edit')</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3"
                                                            ...
                                                            data-id="{{ $order->id }}"
                                                            data-kt-ecommerce-order-filter="delete_row">@lang('dashboard.delete')</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                </div>
                                                <!--end::Menu-->
