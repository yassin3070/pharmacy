...
@section('pageTitle' , __('dashboard.roles'))
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="@lang('dashboard.search_title', ['page_title' => __('dashboard.role')])" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--end::Card title-->
                            ...
                            <tr data-id="{{$role->id}}">
                                ...
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid ">
                                        <input class="form-check-input checkSingle" type="checkbox" value="1" id="{{$role->id}}"/>
                                    </div>
                                </td>
                                <!--end::Checkbox-->
                                <!--begin::Category=-->
                                <td>
                                    <div class="d-flex">
                                        <!--begin::Thumbnail-->
                                        <a href="{{ route('roles.edit', $role->id) }}" class="symbol symbol-50px">
                                            {{-- <span class="symbol-label" style="background-image:url({{$role->image}});"></span> --}}
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="{{ route('roles.edit', $role->id) }}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{lang() == "ar" ? $role->nickname_ar : $role->nickname_en}}</a>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="text-muted fs-7 fw-bolder"></div>
                                            <!--end::Description-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <!--begin::Badges-->
                                    <div class="badge badge-light-success">{{lang() == "ar" ? $role->nickname_ar : $role->nickname_en}}</div>
                                    <!--end::Badges-->
                                </td>
                                <!--end::Type=-->
                                <!--begin::Action=-->
