...
@section('pageTitle' , __('dashboard.update_title', ['page_title' => __('dashboard.initial_page')]))
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">@lang('dashboard.update_title', ['page_title' => __('dashboard.initial_page')])</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">@lang('dashboard.update_title', ['page_title' => __('dashboard.initial_page')])</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form id="kt_ecommerce_add_product_form" action="{{ route('initial-pages.update', $page->id) }}" method="POST"
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                    ...
                                    <option></option>
                                    <option value="1" {{ $page->is_active ? "selected='selected'" : ""}} >@lang('dashboard.active')</option>
                                    <option value="0" {{ !$page->is_active ? "selected='selected'" : ""}}>@lang('dashboard.not_active')</option>
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div>
                                                ...
                                                <textarea id="kt_ecommerce_add_product_description_ar" name="desc[ar]" class="form-control form-control-solid"
                                                    style="height: 249px;">{{$page->getTranslations('desc')['ar']}}</textarea>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div>
                                                ...
                                                <textarea id="kt_ecommerce_add_product_description_en" name="desc[en]" class="form-control form-control-solid"
                                                    style="height: 249px;">{{$page->getTranslations('desc')['en']}}</textarea>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                                <div class="text-muted fs-7">@lang('dashboard.desc_requirments',['page_title' => __('dashboard.initial_page')])</div>
                                                <!--end::Description-->
