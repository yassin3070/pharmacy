            ...
            <div class="card-body pt-9 pb-0">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex my-4">
                                ...
                                <a href="#" class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_offer_a_deal">@lang('dashboard.send_notification')</a>
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5" href="{{ route('users.edit' , $user->id)}}">Settings</a>
                    </li>
                    <!--end::Nav item-->
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{ route('user-attachemts' , $user->id)}}">attachments</a>
                    </li>
                    <!--end::Nav item-->
            ...
            <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            <!--begin::Name-->
                            <a href="{{$user->identity_image}}" class="text-gray-800 text-hover-primary d-flex flex-column">
                                <!--begin::Image-->
                                ...
                                <!--end::Image-->
                                <!--begin::Title-->
                                <div class="fs-5 fw-bolder mb-2">@lang('dashboard.identity_image')</div>
                                <!--end::Title-->
                            </a>
                            <!--end::Name-->
                        </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            <!--begin::Name-->
                            <a href="{{$user->car_image}}" class="text-gray-800 text-hover-primary d-flex flex-column">
                                <!--begin::Image-->
                                <div class="symbol symbol-75px mb-5">
                                    <img src="{{$user->car_image}}" alt="">
                                </div>
                                <!--end::Image-->
                                <!--begin::Title-->
                                <div class="fs-5 fw-bolder mb-2">@lang('dashboard.car_image')</div>
                                <!--end::Title-->
                            </a>
                            <!--end::Name-->
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            <!--begin::Name-->
                            <a href="{{$user->car_license}}" class="text-gray-800 text-hover-primary d-flex flex-column">
                                <!--begin::Image-->
                                <div class="symbol symbol-75px mb-5">
                                    <img src="{{$user->car_license}}" alt="">
                                </div>
                                <!--end::Image-->
                                <!--begin::Title-->
                                <div class="fs-5 fw-bolder mb-2">@lang('dashboard.car_license')</div>
                                <!--end::Title-->
                            </a>
                            <!--end::Name-->
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            <!--begin::Name-->
                            <a href="{{$user->front_car_image}}" class="text-gray-800 text-hover-primary d-flex flex-column">
                                <!--begin::Image-->
                                <div class="symbol symbol-75px mb-5">
                                    <img src="{{$user->front_car_image}}" alt="">
                                </div>
                                <!--end::Image-->
                                <!--begin::Title-->
                                <div class="fs-5 fw-bolder mb-2">@lang('dashboard.front_car_image')</div>
                                <!--end::Title-->
                            </a>
                            <!--end::Name-->
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            <!--begin::Name-->
                            <a href="{{$user->back_car_image}}" class="text-gray-800 text-hover-primary d-flex flex-column">
                                <!--begin::Image-->
                                <div class="symbol symbol-75px mb-5">
                                    <img src="{{$user->back_car_image}}" alt="">
                                </div>
                                <!--end::Image-->
                                <!--begin::Title-->
                                <div class="fs-5 fw-bolder mb-2">@lang('dashboard.back_car_image')</div>
                                <!--end::Title-->
                            </a>
                            <!--end::Name-->
