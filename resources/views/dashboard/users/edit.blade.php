                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('users.index') }}"
                            class="text-muted text-hover-primary">@lang('dashboard.users')</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <!--begin::Form-->
                    <form id="kt_ecommerce_add_product_form" method="POST" action="{{ route('users.update' , $user->id)}}" class="form fv-plugins-bootstrap5 fv-plugins-framework store" 
                        data-kt-redirect="{{route('users.index')}}" novalidate="novalidate" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <!--begin::Card body-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            <input type="text" name="first_name"
                                                ...
                                                placeholder="@lang('dashboard.first_name')" value="{{ $user->first_name }}">
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            <input type="text" name="last_name"
                                                ...
                                                placeholder="@lang('dashboard.last_name')" value="{{ $user->last_name }}">
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="text" name="email"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="@lang('dashboard.email')" value="{{ $user->email }}">
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="tel"  id="phone"
                                        class="form-control form-control-lg form-control-solid"
                                        placeholder="@lang('dashboard.phone')" value="{{$user->phone}}">
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <!--end::Col-->
                            </div>
                                ...
                                <div class="col-lg-8 d-flex align-items-center">
                                    <div class="form-check form-check-solid form-switch fv-row">
                                        <input class="form-check-input w-45px h-30px" name="is_notify" value="1"
                                            type="checkbox" id="allownotification" {{$user->is_notify ? "checked='checked'" : ""}}>
                ...
                <!--begin::Deactivate Account-->
                 <div class="card">
                    ...
                    <div id="kt_account_settings_deactivate" class="collapse show">
                        <!--begin::Form-->
                        <form id="kt_account_deactivate_form" method="POST" action="{{ route('activations-status' , $user->id)}}" 
                            class="form fv-plugins-bootstrap5 fv-plugins-framework" data-kt-redirect="{{route('users.index')}}" novalidate="novalidate">
                            @csrf
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                <!--begin::Notice-->
                                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <div class="fw-bold" id="deactivate_desc">
                                            {!!$user->is_active ? __('dashboard.deactivate_desc') : __('dashboard.activate_desc') !!}
                                            <br>
                                        </div>
                                        </div>
                                        <!--end::Content-->
                                ...
                                <div class="form-check form-check-solid fv-row fv-plugins-icon-container">
                                    ...
                                    <label class="form-check-label fw-bold ps-2 fs-6" id="deactivate_text" for="deactivate">{{$user->is_active ? __('dashboard.confirm_deactivate') : __('dashboard.confirm_activate')  }}</label>
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                                <!--end::Form input row-->
                            </div>
                            ...
                            <!--begin::Card footer-->
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <button id="kt_account_deactivate_account_submit" type="submit" class="btn btn-danger fw-bold">{{$user->is_active ? __('dashboard.deactivate_account') : __('dashboard.activate_account') }}</button>
                            </div>
                            <!--end::Card footer-->
